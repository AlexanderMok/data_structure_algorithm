...
/**
 *  FIFO queues. A FIFO queue is a collection that is based on the first-in-first-out (FIFO) policy.
 *  
 ...
 *  linked-list nodes.
 *  
 *  模拟现实中的排队情况。基本操作有入队、出队、获取对头元素、是否空队列、顺序迭代
 *  单链表存储队列元素
 *  
 * @author Alex
 *
...
public class Queue<T> implements Iterable<T> {
	...
	public void enqueue(T item){
		...
		if(isEmpty()) {
			...
			oldLast.next = last;  //如此做，是方便做FIFO
		}
		size++;
	}
